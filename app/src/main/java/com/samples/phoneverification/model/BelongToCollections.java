...
public class BelongToCollections implements Serializable {
    ...
    @SerializedName("id")
    public int collection_movie_id;
    ...
    public BelongToCollections(int collection_movie_id, String collection_movie_name, String collection_movie_posterPath, String collection_movie_backdropPath) {
    ...
    public int getCollection_movie_id() {
